...
async function getWeatherData(latitude, longitude) {
    try {
        const query = "https://api.open-meteo.com/v1/forecast" +
                      ...
                      "&daily=sunrise,sunset,sunshine_duration,daylight_duration,temperature_2m_min,temperature_2m_max,relative_humidity_2m_min,relative_humidity_2m_max,precipitation_sum,precipitation_hours";
